...
declare module '@deepseek-ai/dsh-client-ui-slots' {
  interface SlotMap {
    ...
    /**
     * Root-level right dock for Mitsu workspace panels. Renders in the right
     * column even without a session, so Assets/Docs/Browser can open on the
     * start screen.
     */
    'rightDock': { kind: 'single'; scope: 'root'; owner: RightDockOwnerProps }
    /**
...
/** Right dock owner share: empty — Mitsu owns the dock state. */
export interface RightDockOwnerProps {}
  ...
  ctx.effect(() => {
    ...
    const disposeRegistration = ctx.slots.register({
      ...
      children: {
        ...
        'rightDock': { kind: 'single', scope: 'root' },
        'shell.overlay': { kind: 'list', scope: 'root' },
      },
