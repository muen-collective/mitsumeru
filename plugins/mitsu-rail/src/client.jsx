import { PanelLeft, Image, FileText, Globe } from 'lucide-react'
    ...
    const RIGHT_RAIL = () => {
      ...
      return (
        <div className="mitsu-rail-nav">
          ...
          <div className="mitsu-rail-avatar" title="Account">TP</div>
          {activePanel && (
            <div className="mitsu-rail-panel">
              <div className="mitsu-rail-panel-title">{activePanel.label}</div>
              <div className="mitsu-rail-panel-note">Mitsu {activePanel.label} surface placeholder.</div>
            </div>
          )}
        </div>
      )
